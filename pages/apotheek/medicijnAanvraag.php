...
<table class="table">
    ...
    <?php
        ...
        foreach ($resultaat as $res) {
            ...
            echo "<td>
                <select id='opgehaald' name='opgehaald'>
                    <option value=".$res['opgehaald'].">".$res['opgehaald']."</option>
                    <option value='ja'>Ja</option>
                </select>
            </td>";
            echo "<td><input type='hidden' name='id' id='aanpassen' value='".$res['id']."'></td>";
            echo "<td><input type='submit' name='aanpassen' id='aanpassen' value='Aanpassen'></td>";
            echo "</tr>";
            echo '</form>';
